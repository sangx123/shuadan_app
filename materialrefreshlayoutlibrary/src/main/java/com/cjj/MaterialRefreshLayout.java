...
public class MaterialRefreshLayout extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defstyleAttr) {
        ...
        colorsId = t.getResourceId(R.styleable.MaterialRefreshLayout_progress_colors, R.array.my_material_colors);
        ...
        textType = t.getInt(R.styleable.MaterialRefreshLayout_progress_text_visibility_m,1);
