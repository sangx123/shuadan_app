...
/**
 * com.github.lzyzsd.circleprogress
 */
public class ArcProgress extends View {
    ...
    private final int default_finished_color =Color.parseColor("#114BFF");
    private final int default_unfinished_color = Color.parseColor("#00000000");
