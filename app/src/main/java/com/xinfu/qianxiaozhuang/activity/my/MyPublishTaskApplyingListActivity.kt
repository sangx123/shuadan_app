...
import kotlinx.android.synthetic.main.activity_my_publish_task_applying_list.*

class MyPublishTaskApplyingListActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_my_publish_task_applying_list)
        mAdapter = object : BaseQuickAdapter<Task, BaseViewHolder>(R.layout.listitem_task_user_list, myPublishList) {
        ...
        mRecycleViewHelper= RecycleViewHelper(mActivity,mRecyclerView,mSwipeRefreshLayout,false, RecycleViewHelper.RecycleViewListener { pageIndex, pageSize ->
