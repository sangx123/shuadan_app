...
public class StatusBarUtil {
    ...
    public static final int DEFAULT_STATUS_BAR_ALPHA = 20;
     ...
     * @return
     */
    public static LinearLayout.LayoutParams getLayoutParams(int width, Context context) {

        return new LinearLayout.LayoutParams(width, StatusBarUtil.getStatusBarHeight(context));
